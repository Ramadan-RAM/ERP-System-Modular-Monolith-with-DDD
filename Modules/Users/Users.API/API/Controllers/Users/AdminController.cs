...
namespace ERP.API.API.Controllers.Users
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterDto dto)
        {
            ...
            var user = new User
            {
                ...
                Profile = new UserProfile
                {
                    ...
                    Gender = dto.Gender,
                    ProfilePicture = new byte[0] // ✅ حل المشكلة هنا
                },
        ...
        {
            var user = await _context.Users
                .Include(u => u.UserAnswers) // مهم جداً لجلب الإجابات
                .FirstOrDefaultAsync(u => u.Id == id);
            ...
            user.DeletedBy = GetCurrentUserId(); // أو يمكن تخصيصها حسب المستخدم الحالي

            // ✅ حذف نهائي للإجابات المرتبطة بالمستخدم من الجدول
